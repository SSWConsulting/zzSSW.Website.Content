...
ServiceList: 
  heading: Consulting
  ilter-item: item consulting-services training-services isotope-header all
...
serviceList: 
  heading: Consulting
  filter-item: item consulting-services training-services isotope-header all
...
serviceList: 
  heading: Creatives
  filter-item: item webdev video appdev mobdev design isotope-header all
...
serviceList: 
  heading: Platforms
  filter-item: item development webdev platforms isotope-header all
...
serviceList: 
  ...
  filter-item: item cms isotope-header all
...
serviceList: 
  ...
  filter-item: item hosting-solutions webdev isotope-header consulting-services all
