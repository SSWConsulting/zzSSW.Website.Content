...
serviceList: 
  ...
  filter_item: item cms development mobdev datadev webdev appdev isotope-header consulting-services all
...
ServiceList: 
  heading: Consulting
  filter_item: item consulting-services training-services isotope-header all
...
serviceList: 
  heading: Creatives
  filter_item: item webdev video appdev mobdev design isotope-header all
...
serviceList: 
  heading: Platforms
  filter_item: item development webdev platforms isotope-header all
...
serviceList: 
  ...
  filter_item: item cms isotope-header all
...
serviceList: 
  ...
  filter_item: item hosting-solutions webdev isotope-header consulting-services all
