...
serviceList: 
  ...
  list_platforms: 
    header: Platforms
    header_filter: item development webdev platforms isotope-header all
  ...
  list_content_management_systems:
    header: Content Management Systems
    header_filter: item cms isotope-header all
  ...
  list_cloud_infrastructure:
    ...
    header_filter: item hosting-solutions webdev isotope-header consulting-services all
