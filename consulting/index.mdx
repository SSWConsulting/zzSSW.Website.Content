...
serviceList: 
  ...
  filterItem: item cms development mobdev datadev webdev appdev isotope-header consulting-services all
...
ServiceList: 
  heading: Consulting
  filterItem: item consulting-services training-services isotope-header all
...
serviceList: 
  heading: Creatives
  filterItem: item webdev video appdev mobdev design isotope-header all
...
serviceList: 
  heading: Platforms
  filterItem: item development webdev platforms isotope-header all
...
serviceList: 
  ...
  filterItem: item cms isotope-header all
...
serviceList: 
  ...
  filterItem: item hosting-solutions webdev isotope-header consulting-services all
